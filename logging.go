...
// ILogger provides interface for elm logger implementations
...
// StandardLogger is the default elm logger implementation.
...
func (l *StandardLogger) WithFields(fields map[string]interface{}) ILogger {
	cp := *l
...
func (l *NoOpLogger) WithFields(fields map[string]interface{}) ILogger {
	cp := *l
	cp.fields = fields
	return &cp
}
